...
CLAUSES = [
    ...
    },
    {
        "id": "clause_2",
        "title": "",
        "text": 'THIS RENTAL AGREEMENT is made and executed on this date of <Today’s Date: P1>,                 AT HYDERABAD',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_6",
        "title": "",
        "text": '<OwnerFatherHusband: P24>/o: <Father Name: P4>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_7",
        "title": "",
        "text": 'Occupation: <Owner Current Occupation: P5>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_8",
        "title": "",
        "text": 'Address:  <Permanent Address of the owner: P6>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_9",
        "title": "",
        "text": '(Here in after called the “Absolute Owner” which term shall mean and include his/her legal representatives, successors, administrators, etc.) Of the First party.',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_9_o2_3",
        "title": "",
        "text": '<Owner2FatherHusband: P43>/o: <Father Name: P44>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_9_o2_4",
        "title": "",
        "text": 'Occupation: <Owner2 Current Occupation: P45>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_9_o2_5",
        "title": "",
        "text": 'Address:  <Permanent Address of the owner: P46>',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_13",
        "title": "",
        "text": '<TenantFatherHusband: P25>/o: <Father Name: P9>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_14",
        "title": "",
        "text": 'Occupation: <Tenant Current Occupation: P10>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_15",
        "title": "",
        "text": 'Address:  <Permanent Address of the Tenant: P11>',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_18",
        "title": "",
        "text": '<TenantFatherHusband: P31>/o: <Father Name: P32>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_19",
        "title": "",
        "text": 'Occupation: <Tenant Current Occupation: P33>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_20",
        "title": "",
        "text": 'Address:  <Permanent Address of the Tenant: P34>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_21",
        "title": "",
        "text": '(Here in after called the “Tenants” Which term Shall mean and include his legal Representatives, Successors, administrators, etc) on the second party.',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_22",
        "title": "",
        "text": 'Whereas the owner is the absolute and Peaceful Possessor of Premises <Rental Property Address: P12>. And being in Lawful Possession of the same and so entitled to let out the said Premises.',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_24",
        "title": "",
        "text": 'Subject to the Terms and Conditions said down hereunder:',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_26",
        "title": "",
        "text": 'The term of rental agreement is for a period of 11 Months with effect from {agreement_start_date} and ends on {agreement_end_date} with an option for renewal of the same by mutual consent with an escalation of {increase_percent} on present rent.',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_42",
        "title": "",
        "text": 'This rental agreement can be further extended with the mutual consent of both the parties with the new agreed Rental Amount.',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_63",
        "title": "",
        "text": 'DESCRIPTION OF THE SAID PREMISES:',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_64",
        "title": "",
        "text": 'All that consisting of premises, at <Rental Property Address: P12>',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_65",
        "title": "",
        "text": 'IN WITNESS, WHERE OF THE PARTIES TO THIS AGREEMENT HAVE SIGNED HEREUNDER ON THE AFORESAID DATE <Today’s Date : P1>',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_67",
        "title": "",
        "text": 'Name: <Owner Name: P2>                                        Signature',
        "locked": False,
        "condition": None
    },
    {
    ...
    },
    {
        "id": "clause_69",
        "title": "",
        "text": 'Name: <Tenant Name: P7>                                        Signature',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_70",
        "title": "",
        "text": 'Name: <Tenant Name: P29>                                        Signature',
        "locked": False,
        "condition": None
    },
    {
        "id": "clause_71",
        "title": "",
        "text": 'IN THE PRESENCE OF WITNESS',
        "locked": False,
        "condition": None
    },
    {
